...
export const MOCK_USERS: UserProfile[] = [
  {
    ...
    joinedAt: "2025-11-15",
    stats: { visited: 42, liked: 28, recommended: 12, spotlines: 3 },
  },
  {
    id: "user-2",
    nickname: "도시산책러",
    ...
    bio: "걸으며 발견하는 서울의 매력",
    joinedAt: "2025-12-01",
    stats: { visited: 67, liked: 45, recommended: 23, spotlines: 5 },
  },
  {
    id: "user-3",
    nickname: "전시덕후",
    ...
    joinedAt: "2026-01-10",
    stats: { visited: 31, liked: 22, recommended: 8, spotlines: 2 },
  },
  {
    id: "user-4",
    nickname: "맛집헌터",
    ...
    joinedAt: "2026-01-20",
    stats: { visited: 55, liked: 38, recommended: 19, spotlines: 4 },
  },
  {
    id: "user-5",
    nickname: "감성여행자",
    ...
    joinedAt: "2026-02-05",
    stats: { visited: 23, liked: 15, recommended: 6, spotlines: 2 },
  },
];
