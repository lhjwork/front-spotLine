      ...
      <div className="p-4">
        ...
        <div className="mb-3">
          ...
          <div className="flex items-center space-x-2 mb-2">
            <span className={`px-2 py-1 rounded-full text-xs font-medium ${getCategoryColor(store.category)}`}>
        ...
        <div className="flex space-x-2">
          <Button
            variant="outline"
            size="sm"
            onClick={() => onMapClick(recommendation)}
            className="flex-1"
          >
          ...
          <Button
            size="sm"
            onClick={() => onStoreClick(recommendation)}
            className="flex-1"
          >
            자세히 보기
          </Button>
