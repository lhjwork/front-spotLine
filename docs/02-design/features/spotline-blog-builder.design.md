...
| **4** | Frontend: SpotLine Builder 페이지 | `app/spotLine-builder/page.tsx`, `components/spotLine-builder/*` (8 컴포넌트), `@dnd-kit` 의존성 설치 | 없음 | High |
...
# @dnd-kit은 이미 admin에서 사용 중이나, front-spotLine에는 미설치
